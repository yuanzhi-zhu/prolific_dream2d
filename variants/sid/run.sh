...
### VSD
CUDA_VISIBLE_DEVICES=2 python prolific_dreamer2d.py \
        --num_steps 1500 --log_steps 72 \
        --seed 1024 --lr 0.01 --phi_lr 0.001 --use_t_phi true \
        --model_path '/cpfs/data/user/yanghuan/huggingface/runwayml/stable-diffusion-v1-5' \
